...
export default function Editmovie() {
    ...
    useEffect(()=>{
        ...
        .then(result => {
            if (result['status']==='ok'){
                setMname(result['movie']['moviename'])
                setReleased(result['movie']['released'])
                setRating(result['movie']['rating'])
                setPhoto(result['movie']['photo'])
                setVdo(result['movie']['vdo'])
                setText(result['movie']['text'])
            }
        })
            ...
            <form onSubmit={handleSubmit}>
                <Grid container spacing={2} sx={{}}>
                    ...
                    <Grid item xs={12}>
                        ...
                        value={released} onChange={(e) => setReleased(e.target.value)}/>
                    </Grid>
                    <Grid item xs={12}>
                    ...
                    <Grid item xs={12}>
                        ...
                        value={vdo} onChange={(e) => setVdo(e.target.value)}/>
                    </Grid>
                    <Grid item xs={12}>
